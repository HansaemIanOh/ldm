...
class DDPM(pl.LightningModule):
    def __init__(
        ...
        **kwargs
        ...
        f_res = self.in_res # [64, 128, 256, 512]
    ...
    def generate(self, num_images, diffusion_steps, initial_noise=None):
        if initial_noise is None:
            initial_noise = torch.randn((num_images, self.h_dims[0], self.in_res, self.in_res), device=self.curr_device)
        ...
        z -> decode -> x
        '''
        # generated_images = self.autoencoder.decode(generated_images)
